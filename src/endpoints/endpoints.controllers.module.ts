...
export class EndpointsControllersModule {
  static forRoot(): DynamicModule {
    ...
    const isMarketplaceFeatureEnabled =
      configuration().features?.marketplace?.enabled ?? false;
    ...
    const isExchangeEnabled =
      ...
      configuration()['plugins']?.['transaction-action']?.['mex']?.[
        'microServiceUrl'
      ];
    ...
    return {
      ...
      imports: [EndpointsServicesModule, ProxyModule, PluginModule],
